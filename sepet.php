...
<?php
    ...
    $con = mysqli_connect("localhost","root","emre75_","site");
    if (isset($_POST["add"])){
        if (isset($_SESSION["sepet"])){
            $item_array_id = array_column($_SESSION["sepet"],"product_id");
    ...
    <div class="container" style="width: 65%">
        ...
        <div class="table-responsive">
            ...
            <tr>
                ...
                <th width="13%">Fiyat detayları</th>
                <th width="10%">Toplam fiyat</th>
                <th width="17%">Öğeyi kaldırmak</th>
            </tr>
                ...
                if(!empty($_SESSION["sepet"])){
                    ...
                    foreach ($_SESSION["sepet"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="sepet.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
                                        class="text-danger">Öğeyi kaldırmak</span></a></td>
